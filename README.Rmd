...
6. Add a line to your `.Renviron` file to set the `pprof_path` environment variable, e.g. `pprof_path=/home/landau/go/bin/pprof` to tell `proffer` where `pprof` lives. [usethis::edit_r_environ()](https://usethis.r-lib.org/reference/edit.html) is particularly handy for this.
